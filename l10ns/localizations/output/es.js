;(function() {
  ...
  function l(key) {
    if(!(key in localizations['es'])) {
      throw new TypeError('Key `' + key + '` not in es localizations');
    }
    return localizations['es'][key].call(localizations['es'], arguments[1]);
  }
